...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <asp:Image ImageUrl="https://us.123rf.com/450wm/koblizeek/koblizeek2208/koblizeek220800128/190320173-sin-s%C3%ADmbolo-de-vector-de-imagen-falta-el-icono-disponible-no-hay-galer%C3%ADa-para-este-marcador-de.jpg" ID="imgNuevoPerfil" AutoPostBack="true" runat="server" CssClass="img-fluid mb-3" />
        </div>
    </div>
</asp:Content>
